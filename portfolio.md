...
**Note**: *While the local version runs OK on my laptop, the app on Amazon cloud often crashes ("disconnected form server" message). I am still investigating this bug, but found that it works if you upload the same file 2 times...* 
